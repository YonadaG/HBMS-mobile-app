    ...
    const settingsSections = [
        {
            ...
            items: [
                ...
                { icon: 'card-outline', label: 'Payment Methods', type: 'navigate' },
                { icon: 'time-outline', label: 'Booking History', type: 'navigate' },
            ]
        },
        {
            title: 'Preferences',
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            ...
            <ScrollView style={styles.container}>
                ...
                >
                    <Ionicons name="log-in-outline" size={22} color={textLight} />
